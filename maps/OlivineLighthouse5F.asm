...
OlivineLighthouse5F_MapEvents:
	...
	db 7 ; object events
	object_event 11, 14, SPRITE_KING, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 4, TrainerLighthouseArcher, EVENT_LIGHTHOUSE_ROCKETS
