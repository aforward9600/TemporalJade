...
RadioTower1F_MapEvents:
	...
	object_event 10, 11, SPRITE_DRAPION, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, RadioTower1FWobbuffetScript, EVENT_GOLDENROD_TOWER_TAKEOVER
