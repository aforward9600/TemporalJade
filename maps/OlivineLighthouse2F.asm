...
OlivineLighthouse2F_MapEvents:
	...
	object_event  8, 14, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Lighthouse2FRivalScript, EVENT_SCHOOL_RIVAL
	...
	object_event 10, 14, SPRITE_RIBOMBEE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, LighthouseRaticateScript, EVENT_LIGHTHOUSE_ROCKETS
