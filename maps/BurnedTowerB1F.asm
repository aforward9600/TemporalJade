...
BurnedTowerB1F_MapEvents:
	...
	object_event 10,  3, SPRITE_PLACEHOLDER_1, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, EnteiBattle, EVENT_BURNED_TOWER_B1F_ENTEI
