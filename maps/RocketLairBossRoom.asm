...
RocketLairBossRoom_MapEvents:
	...
	object_event 10,  1, SPRITE_CLODSIRE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_BOSS_ROOM_POKEMON
	object_event 12,  1, SPRITE_CONKELDURR, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_BOSS_ROOM_POKEMON
