...
.o:        db FERALIGATR, FURRET, TYROGUE, PRIMEAPE, SENTRET, MAGBY, SPEAROW, FEAROW, CARRACOSTA, TIRTOUGA, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, BLISSEY, MARSHTOMP, SWAMPERT, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1
.ki_gi:    db SUNFLORA, PIKIPEK, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, LICKILICKY, KINGLER, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, TOUCANNON, SCIZOR, HOPPIP, KINGDRA, PARAS, PARASECT, QWILFISH, MR__MIME, TANGROWTH, CLOYSTER, MISMAGIUS, -1
...
.ho_bo_po: db POLITOED, HOOTHOOT, VENIPEDE, PONYTA, SKIPLOOM, PORYGON, SMOOCHUM, -1
...
.ra:       db YANMEGA, RAICHU, CHANSEY, RIBOMBEE, LAPRAS, VILEPLUME, LANTURN, -1
