...
.ki_gi:    db SUNFLORA, PIKIPEK, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, LICKILICKY, CRAWDAUNT, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, CORPHISH, GRANBULL, CROBAT, -1
