...
MonMenuIcons:
	...
	db ICON_DARTRIX     ; DARTRIX
	db ICON_DECIDUEYE   ; DECIDUEYE
	db ICON_TEPIG       ; TEPIG
	db ICON_PIGNITE     ; PIGNITE
	db ICON_EMBOAR      ; EMBOAR
	db ICON_MUDKIP      ; MUDKIP
	db ICON_MARSHTOMP   ; MARSHTOMP
	db ICON_SWAMPERT    ; SWAMPERT
	db ICON_PIKIPEK     ; PIKIPEK
	db ICON_TRUMBEAK    ; TRUMBEAK
	db ICON_TOUCANNON   ; TOUCANNON
	db ICON_LILLIPUP    ; LILLIPUP
	db ICON_HERDIER     ; HERDIER
	db ICON_STOUTLAND   ; STOUTLAND
	db ICON_VENIPEDE    ; VENIPEDE
	db ICON_WHIRLIPEDE  ; WHIRLIPEDE
	db ICON_SCOLIPEDE   ; SCOLIPEDE
	db ICON_CUTIEFLY    ; CUTIEFLY
	...
	db ICON_TIRTOUGA    ; TIRTOUGA
	db ICON_CARRACOSTA  ; CARRACOSTA
	db ICON_ARCHEN      ; ARCHEN
	db ICON_ARCHEOPS    ; ARCHEOPS
	...
	db ICON_KARRABLAST  ; KARRABLAST
	db ICON_ESCAVALIER  ; ESCAVALIER
	db ICON_SHELMET     ; SHELMET
	db ICON_ACCELGOR    ; ACCELGOR
