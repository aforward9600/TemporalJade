...
MapGroup_Zaconia:
	...
	map CharcoalKiln, TILESET_HOUSE, INDOOR, ZACONIA_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaMart, TILESET_MART, INDOOR, ZACONIA_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map KurtsHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, ZACONIA_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ZaconiaCity, TILESET_JOHTO_3, TOWN, ZACONIA_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route26HealHouse, TILESET_HOUSE, INDOOR, ROUTE_31, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HusCavern, TILESET_CAVE, CAVE, DRAGONS_DEN, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map OrrianDesert, TILESET_JOHTO_3, ROUTE, ORRIAN_DESERT, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
