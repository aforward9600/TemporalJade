...
MapGroup_Olivine:
	...
	map Route38EcruteakGate, TILESET_GATE, GATE, ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	map MahoganyRedGyaradosSpeechHouse, TILESET_HOUSE, INDOOR, MAHOGANY_TOWN, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MahoganyTown, TILESET_JOHTO, TOWN, MAHOGANY_TOWN, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FossilHouse, TILESET_FACILITY, INDOOR, ROUTE_42, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_POND
	map SilverCaveSummitOutside, TILESET_JOHTO, ROUTE, SILVER_CAVE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI

MapGroup_Dungeons:
	map SproutTower1F, TILESET_TOWER, DUNGEON, CRESCENT_LAKE, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower2F, TILESET_TOWER, DUNGEON, CRESCENT_LAKE, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SproutTower3F, TILESET_TOWER, DUNGEON, CRESCENT_LAKE, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map DragonsDen1F, TILESET_CAVE, CAVE, ICE_PATH, MUSIC_SCANTELES_TOWN, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	...
	map BlackRiverPassageRoute25, TILESET_DARK_CAVE, CAVE, DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
...
MapGroup_Zaconia:
	map AzaleaPokecenter1F, TILESET_POKECENTER, INDOOR, ZACONIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CharcoalKiln, TILESET_HOUSE, INDOOR, ZACONIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaMart, TILESET_MART, INDOOR, ZACONIA_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map KurtsHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, ZACONIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaGym, TILESET_ELITE_FOUR_ROOM, INDOOR, ZACONIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route33, TILESET_JOHTO_MODERN, ROUTE, ROUTE_33, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ZaconiaCity, TILESET_JOHTO_3, TOWN, ZACONIA_CITY, MUSIC_LAVERRE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route31, TILESET_JOHTO, ROUTE, ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CrescentLake, TILESET_JOHTO, ROUTE, CRESCENT_LAKE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route26HealHouse, TILESET_HOUSE, INDOOR, ROUTE_31, MUSIC_LAVERRE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HusCavern, TILESET_CAVE, CAVE, DRAGONS_DEN, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map OrrianDesert, TILESET_JOHTO_3, ROUTE, ORRIAN_DESERT, MUSIC_PYRITE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map ScantelesTown, TILESET_CAVE, CAVE, ICE_PATH, MUSIC_SCANTELES_TOWN, FALSE, PALETTE_NITE, FISHGROUP_POND
	map HusCavernB1F, TILESET_CAVE, CAVE, DRAGONS_DEN, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Violet:
	...
	map EarlsPokemonAcademy, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_CableClub:
	...
	map TradeCenter, TILESET_GATE, INDOOR, SPECIAL_MAP, MUSIC_FLOAROMA_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Colosseum, TILESET_GATE, INDOOR, SPECIAL_MAP, MUSIC_FLOAROMA_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TimeCapsule, TILESET_GATE, INDOOR, SPECIAL_MAP, MUSIC_FLOAROMA_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_MurkrowValley:
	...
	map Route29, TILESET_JOHTO, ROUTE, ROUTE_29, MUSIC_ROUTE_101, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MurkrowValley, TILESET_JOHTO, TOWN, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ElmsLab, TILESET_LAB, INDOOR, MURKROW_VALLEY, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersNeighborsHouse, TILESET_HOUSE, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ElmsHouse, TILESET_PLAYERS_HOUSE, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route29Route46Gate, TILESET_GATE, GATE, ROUTE_29, MUSIC_ROUTE_101, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalsHouse2F, TILESET_PLAYERS_ROOM, INDOOR, MURKROW_VALLEY, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	map Route30, TILESET_JOHTO, ROUTE, ROUTE_30, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CherrygroveCity, TILESET_JOHTO, TOWN, CHERRYGROVE_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map CherrygroveGymSpeechHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GuideGentsHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveEvolutionSpeechHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route30BerryHouse, TILESET_HOUSE, INDOOR, ROUTE_30, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, ROUTE_30, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route31VioletGate, TILESET_GATE, GATE, ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveFisherHouse, TILESET_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_FLOAROMA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map MoravilSchoolOutside, TILESET_JOHTO, TOWN, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map MoravilSchoolHallway, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MoravilSchoolNursesOffice, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MoravilSchoolStore, TILESET_MART, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MoravilSchoolComputerLab, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MoravilSchoolPlayground, TILESET_JOHTO, ROUTE, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map MoravilSchoolLibrary, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_MORAVIL_SCHOOL, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map MoravilSchoolGym, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_BellchimePath:
	map BellchimePath, TILESET_JOHTO, ROUTE, ORRIAN_DESERT, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map MtSilverSummit, TILESET_SUMMIT, ROUTE, SILVER_CAVE, MUSIC_UNWAVERING_HEART, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map GoldCrystalHouse, TILESET_PLAYERS_HOUSE, INDOOR, SILVER_CAVE, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
