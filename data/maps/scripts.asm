...
INCLUDE "maps/MoravilSchoolOutside.asm"
INCLUDE "maps/MoravilSchoolHallway.asm"
INCLUDE "maps/MoravilSchoolNursesOffice.asm"
INCLUDE "maps/MoravilSchoolStore.asm"
...
INCLUDE "maps/ScantelesTown.asm"
INCLUDE "maps/HusCavernB1F.asm"
