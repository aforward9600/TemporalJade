...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_GIRL,      DEINO,      DRATINI,    "Drake@@@@@@", $ea, $aa, SITRUS_BERRY, 26491, "Jewel@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, PHANPY,     PIKACHU,    "Pooka@@@@@@", $96, $66, LIGHT_BALL,   50082, "Forest@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, ELEKID,     TEPIG,      "Flameo@@@@@", $96, $77, LEPPA_BERRY,  49635, "Rocky@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, SMOOCHUM,   ROWLET,     "Bubsy@@@@@@", $96, $77, LUM_BERRY,    42069, "Sheldon@", TRADE_GENDER_FEMALE
